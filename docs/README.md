...
| **Experimenter**    | Run pipeline for new experiments without debugging. | [RUN_ON_CLOUD.md](./installation/RUN_ON_CLOUD.md)                  |
| **Power-User**      | Run specific computations, debugging locally and in the cloud.                  | [RUN_LOCALLY.md](./installation/RUN_LOCALLY.md), [RUN_ON_CLOUD.md](./installation/RUN_ON_CLOUD.md) |
| **Developer/Admin** | Extend, maintain, and debug pipeline.                                | [INSTALLATION_AND_CONFIGURATION.md](./installation/INSTALLATION_AND_CONFIGURATION.md), [TROUBLESHOOTING.md](./troubleshooting/TROUBLESHOOTING.md) |
